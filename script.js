...
formPaquetes.especial.addEventListener("change", function() {
    if (this.checked) {
        formPaquetes.diasPaquete.value = "";
        formPaquetes.diasPaquete.disabled = true;
        formPaquetes.destino.value = "";
    } else {
        formPaquetes.diasPaquete.disabled = false;
    }
});

formPaquetes.destino.addEventListener("change", function() {
    if (this.value) {
        formPaquetes.especial.checked = false;
        formPaquetes.diasPaquete.disabled = false;
    }
});
